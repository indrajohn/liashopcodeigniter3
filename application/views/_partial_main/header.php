...
<head>
	...
	<!--<link rel="stylesheet" href="assets/css/font-awesome/fontawesome.min.css" type="text/css" /> -->
	...
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/toolbar.css" type="text/css">
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/elegant-icons.css" type="text/css">
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/jquery-min.css" type="text/css" />
	...
	<script src="<?php echo base_url();?>assets/js/owl-carousel/owl-carousel.min.js" defer></script>
	<script src="<?php echo base_url();?>assets/js/font-awesome/font-awesome-all.min.js" defer></script>
	<script src="<?php echo base_url();?>assets/js/slicknav.js" defer></script>
	<script src="<?php echo base_url();?>assets/js/nice-scroll.js" defer></script>
