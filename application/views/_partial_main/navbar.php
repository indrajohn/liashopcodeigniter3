        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto toolbar-link">
                ...
                <li class="nav-item ms-5" style="cursor:default">
                    <a class="nav-link <?php if ($head == 'aboutus') echo 'active' ?>" href="about-us"> About Us</i>
                    </a>
                </li>
                <li class="nav-item ms-5" style="cursor:default">
                    <a class="nav-link <?php if ($head == 'product') echo 'active' ?>" href="product"> Product</i> </a>
                </li>
                <li class="nav-item ms-5" style="cursor:default">
                    <a class="nav-link <?php if ($head == 'contactus') echo 'active' ?>" href="contact-us">Contact
                        us</i> </a>
                </li>
            </ul>
